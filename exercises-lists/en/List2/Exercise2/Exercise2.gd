...
func generate_times_table(n: int) -> void:
	# TODO: Return a string with the times table of n (1 to 10)
	"""
	...
	* -> Multiplication
	...
	Use the "add_times_table" function to display the result
	of a times table on the screen
	
	here's an example:
	add_times_table(number1, "+", number2, number1 + number2)
	"""
	pass
